...
import com.logaritex.mcp.method.resource.DefaultMcpReadResourceResultConverter;
...
public class SyncMcpToolMethodCallback extends AbstractMcpToolMethodCallback
    ...
    public static SyncMcpToolMethodCallback.Builder builder() {
        return new SyncMcpToolMethodCallback.Builder();
    }
